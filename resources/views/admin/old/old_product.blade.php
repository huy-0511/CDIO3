            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Old Product</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Old Product</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        @foreach($old as $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('admin/product_old/edit/'.$value['id'])}}" class="btn btn-xs btn-success">Edit</a>
                                                    <a href="{{url('admin/product_old/delete/'.$value['id'])}}" class="btn btn-xs btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    ...
                                    <p><a href="{{url('admin/product_old/add')}}" class="btn btn-xs btn-danger">Add</a></p>
                                    {{$old->links()}}
