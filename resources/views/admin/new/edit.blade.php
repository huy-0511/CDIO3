                                ...
                                <form action="" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="name" value="<?php echo $data['name']; ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Unit_price</label>
                                        <div class="col-md-12">
                                           <input name="unit_price" value="<?php echo $data['unit_price']; ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">promotion_price</label>
                                        <div class="col-md-12">
                                            <input name="promotion_price" value="<?php echo $data['promotion_price']; ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $data['description']; ?>" name="des">
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Unit</label>
                                        <div class="col-md-12">
                                             
                                            <input type="text" name="unit" value="<?php echo $data['unit']; ?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <a href="{{url('admin/product_new')}}"class="btn btn-success">Back</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
